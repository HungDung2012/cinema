...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                <a href="${pageContext.request.contextPath}/Xemlichchieuphim.jsp">
                    <button type="submit" class="submit-btn">Xem Lịch Chiếu Phim</button>
                </a>
            </div>
            
            <div method="post" action="${pageContext.request.contextPath}/addschedule-pre">
                <button type="submit" class="submit-btn">Lập Lịch Chiếu Phim</button>
            </div>
